...
class Section:
    """
    在配置文件 mkdocs.yml 中的 nav 对应的配置里面，包含有孩子节点的
    节点对应的就是 Section，这些节点都不对具体的markdown文件，而那些
    没有孩子节点，有具体的markdown文件的节点对应的类是Page
    """

    def __init__(self, title, children):
        self.title = title
        # 孩子节点，孩子节点中可能是Page对象，也可能是Section对象，取决于 mkdocs.yml 中nav节点的配置
